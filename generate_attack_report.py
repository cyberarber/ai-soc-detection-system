...
with open("kali_attack_report.md", "w") as f:
    f.write(report)

print("Report saved as kali_attack_report.md")
print("\nKey Achievement:")
print("✅ Successfully demonstrated cross-VM attack simulation")
print("✅ Kali Linux → Ubuntu attack path established")
print("✅ Real-world SOC scenario executed")
